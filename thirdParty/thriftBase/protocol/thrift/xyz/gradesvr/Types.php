      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \xyz\gradesvr\GradeInfo();
              $xfer += $elem40->read($input);
              $this->gradeinfo_list []= $elem40;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem46 = null;
              $elem46 = new \xyz\gradesvr\VipGradeInfo();
              $xfer += $elem46->read($input);
              $this->vip_gradeinfo_list []= $elem46;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->gradeinfo_list !== null) {
      ...
      $xfer += $output->writeFieldBegin('gradeinfo_list', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->gradeinfo_list));
        {
          foreach ($this->gradeinfo_list as $iter47)
          {
    ...
    if ($this->vip_gradeinfo_list !== null) {
      ...
      $xfer += $output->writeFieldBegin('vip_gradeinfo_list', TType::LST, 4);
      {
        $output->writeListBegin(TType::STRUCT, count($this->vip_gradeinfo_list));
        {
          foreach ($this->vip_gradeinfo_list as $iter48)
          {
