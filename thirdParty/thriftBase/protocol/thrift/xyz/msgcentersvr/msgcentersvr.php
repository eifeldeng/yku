...
interface msgcentersvrIf {
   ...
   * @param \xyz\msgcentersvr\RedPointCondition $condition
   * @return \xyz\msgcentersvr\RetRedPoint
   */
  public function check_red_point(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\RedPointCondition $condition);
  /**
   * @param \xyz\msgcentersvr\TerminalProperty $termproperty
   * @param int $msgid
   * @return \xyz\msgcentersvr\retcomm
   ...
   * @param \xyz\msgcentersvr\TerminalProperty $termproperty
   * @param \xyz\msgcentersvr\IndexpageMessageCondition $condition
   * @return \xyz\msgcentersvr\RetIndexpageMsglist
   */
  public function get_indexpage_msglist(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\IndexpageMessageCondition $condition);
  /**
   * @param \xyz\msgcentersvr\TerminalProperty $termproperty
...
class msgcentersvrClient implements \xyz\msgcentersvr\msgcentersvrIf {
  ...
  public function check_red_point(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\RedPointCondition $condition)
  {
    $this->send_check_red_point($termproperty, $condition);
    return $this->recv_check_red_point();
  }

  public function send_check_red_point(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\RedPointCondition $condition)
  {
    $args = new \xyz\msgcentersvr\msgcentersvr_check_red_point_args();
    $args->termproperty = $termproperty;
    $args->condition = $condition;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'check_red_point', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('check_red_point', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_check_red_point()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\xyz\msgcentersvr\msgcentersvr_check_red_point_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \xyz\msgcentersvr\msgcentersvr_check_red_point_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("check_red_point failed: unknown result");
  }
  ...
  public function get_indexpage_msglist(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\IndexpageMessageCondition $condition)
  {
    $this->send_get_indexpage_msglist($termproperty, $condition);
    return $this->recv_get_indexpage_msglist();
  }

  public function send_get_indexpage_msglist(\xyz\msgcentersvr\TerminalProperty $termproperty, \xyz\msgcentersvr\IndexpageMessageCondition $condition)
  {
    $args = new \xyz\msgcentersvr\msgcentersvr_get_indexpage_msglist_args();
    $args->termproperty = $termproperty;
    $args->condition = $condition;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_indexpage_msglist', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('get_indexpage_msglist', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_get_indexpage_msglist()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\xyz\msgcentersvr\msgcentersvr_get_indexpage_msglist_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \xyz\msgcentersvr\msgcentersvr_get_indexpage_msglist_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("get_indexpage_msglist failed: unknown result");
  }
  ...
  public function write($output) {
    ...
    if ($this->touidlist !== null) {
      ...
      $xfer += $output->writeFieldBegin('touidlist', TType::LST, 1);
      {
        ...
        {
          foreach ($this->touidlist as $iter182)
          {
            $xfer += $output->writeI64($iter182);
          }
        }
        $output->writeListEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->touidlist !== null) {
      ...
      $xfer += $output->writeFieldBegin('touidlist', TType::LST, 1);
      {
        $output->writeListBegin(TType::I64, count($this->touidlist));
        {
          foreach ($this->touidlist as $iter189)
          {
...
class msgcentersvr_check_red_point_args {
  static $_TSPEC;
  ...
  /**
   * @var \xyz\msgcentersvr\RedPointCondition
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'condition',
          'type' => TType::STRUCT,
          'class' => '\xyz\msgcentersvr\RedPointCondition',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'msgcentersvr_check_red_point_args';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->condition = new \xyz\msgcentersvr\RedPointCondition();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('msgcentersvr_check_red_point_args');
...
class msgcentersvr_check_red_point_result {
  static $_TSPEC;

  /**
   * @var \xyz\msgcentersvr\RetRedPoint
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\xyz\msgcentersvr\RetRedPoint',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'msgcentersvr_check_red_point_result';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \xyz\msgcentersvr\RetRedPoint();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('msgcentersvr_check_red_point_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
  ...
  public function write($output) {
    ...
    if ($this->msgidlist !== null) {
      ...
      $xfer += $output->writeFieldBegin('msgidlist', TType::LST, 2);
      {
        ...
        {
          foreach ($this->msgidlist as $iter196)
          {
...
class msgcentersvr_get_indexpage_msglist_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'msgcentersvr_get_indexpage_msglist_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('msgcentersvr_get_indexpage_msglist_args');
    if ($this->termproperty !== null) {
      if (!is_object($this->termproperty)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class msgcentersvr_get_indexpage_msglist_result {
  static $_TSPEC;

  /**
   * @var \xyz\msgcentersvr\RetIndexpageMsglist
   */
  public $success = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\xyz\msgcentersvr\RetIndexpageMsglist',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function getName() {
    return 'msgcentersvr_get_indexpage_msglist_result';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \xyz\msgcentersvr\RetIndexpageMsglist();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('msgcentersvr_get_indexpage_msglist_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
