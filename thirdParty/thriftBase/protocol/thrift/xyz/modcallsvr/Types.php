...
final class ErrorCode {
  ...
  const ERR_EXIST_SAMEID = -400001001;
  static public $__names = array(
    -400001001 => 'ERR_EXIST_SAMENAME',
    -400001001 => 'ERR_EXIST_SAMEID',
  );
}
...
class NewIfIdReq {
  ...
  public function write($output) {
    ...
    if ($this->ifaceid !== null) {
      $xfer += $output->writeFieldBegin('ifaceid', TType::I32, 2);
      $xfer += $output->writeI32($this->ifaceid);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->ifacename !== null) {
...
class ReportMcReqMsg {
  ...
  public function write($output) {
    ...
    if ($this->callermodid !== null) {
      $xfer += $output->writeFieldBegin('callermodid', TType::I32, 1);
    ...
    if ($this->suc !== null) {
      $xfer += $output->writeFieldBegin('suc', TType::I32, 3);
      $xfer += $output->writeI32($this->suc);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->retcode !== null) {
      $xfer += $output->writeFieldBegin('retcode', TType::I32, 4);
      $xfer += $output->writeI32($this->retcode);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->calleeip !== null) {
      $xfer += $output->writeFieldBegin('calleeip', TType::I32, 5);
      $xfer += $output->writeI32($this->calleeip);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->callerip !== null) {
      $xfer += $output->writeFieldBegin('callerip', TType::I32, 6);
      $xfer += $output->writeI32($this->callerip);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->usetime !== null) {
      $xfer += $output->writeFieldBegin('usetime', TType::I32, 7);
      $xfer += $output->writeI32($this->usetime);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->nowtime !== null) {
      $xfer += $output->writeFieldBegin('nowtime', TType::I32, 8);
