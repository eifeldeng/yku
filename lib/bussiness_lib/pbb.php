...
class TP_Pbb{
    ...
    private static $_tv_config_key = "pbb2:tv:config";
    private static $_zy_config_key = "pbb2:zy:config";
    private static $_zpd_config_key = "pbb2:zpd:config";
    private static $_movie_config_key = "pbb2:movie:config";
    private static $_movie_homemade_config_key = "pbb2:movie:homemade:config";

    private static $_recommend_config_key = "pbb2:recommend:config";

    private static $_show_video_data_prefix_key = "pbb2:video:data:";
    private static $_show_video_list_key = "pbb2:video:list";
